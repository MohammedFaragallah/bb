...
export class MessengerCustomerChat extends Component {
	static propTypes = {
	...
	loadSDKAsynchronously() {
		...
		(function (d, s, id) {
			var js,
				fjs = d.getElementsByTagName(s)[FIRST_ITEM];
	...
	render() {
		...
		// Add a random key to re-render. Reference:
		// https://stackoverflow.com/questions/30242530/dangerouslysetinnerhtml-doesnt-update-during-render
		return <div dangerouslySetInnerHTML={this.createMarkup()} key={Date()} />;
	}
}
